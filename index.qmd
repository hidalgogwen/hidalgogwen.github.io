...
## Value of Rice Production in the Philippines, 2000-2024 {.tiny-text}
...
## Share of Rice Production in GDP, 2000-2024 {.tiny-text}
...
## Contribution of Rice to Headline Inflation, 2010-2024 {.tiny-text}
...
<iframe src="https://arcane-dimension.shinyapps.io/FFRS/" width="175%" height="1000px" style="border: none;">
...
## Annual Palay Production in the Philippines, 1970-2024 {.tiny-text}
...
## Annual Rice Area Harvested in the Philippines, 1970-2024 {.tiny-text}
...
## Annual Yield in the Philippines, 1970-2024 {.tiny-text}
...
## Production and Yield trends in the Philippines, 1970-2024 {.tiny-text}
...
-   *2023 and 2024 - NRP computed based on PSA data*.
...
## Average Cost and Returns of Palay Production, 2002-2023 {.tiny-text}
...
## Monthly IPP, Wholesale, and Retail Prices, 2016-Present {.tiny-text}
